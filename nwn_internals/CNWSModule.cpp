...
int 			(__thiscall *CNWSModule__FindObjectByTagOrdinal)(CNWSModule *pTHIS, CExoString *sTag, int nNth) = (int (__thiscall*)(CNWSModule *pTHIS, CExoString *sTag, int nNth))0x004DA780;
...
int CNWSModule_s::FindObjectByTagOrdinal(CExoString *sTag, int nNth) {
